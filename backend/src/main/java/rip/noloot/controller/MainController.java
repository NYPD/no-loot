...
public class MainController {
    ...
    /**
     * Controller that takes every request besides "index.html" or "api/something" and forwards it to root directory which
     * Vue's router will pick up and display the appropriate page.
     * 
