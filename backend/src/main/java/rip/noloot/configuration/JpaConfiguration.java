...
import rip.noloot.domain.Domain;
...
public class JpaConfiguration {
    ...
    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(Environment springEnvironment) {
        ...
        vendorAdapter.setDatabasePlatform("org.hibernate.dialect." + (isTest ? "HSQLDialect" : "MySQL8Dialect"));
    ...
    private Properties jpaProperties() {
        ...
        properties.setProperty("hibernate.default_schema", "no_loot");
        return properties;
    }
}
